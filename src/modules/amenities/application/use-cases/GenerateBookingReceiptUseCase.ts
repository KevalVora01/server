...
export class GenerateBookingReceiptUseCase {
  ...
  async execute(bookingId: number, requestingUser?: RequestingUser): Promise<string> {
    ...
    const pdfUrl = await this.bookingPdfService.generateAndUpload(booking, amenity);
