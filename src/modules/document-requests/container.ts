...
const uploadDocumentUseCase = new UploadDocumentUseCase(documentRequestRepository, cloudinaryService);
const rejectRequestUseCase = new RejectRequestUseCase(documentRequestRepository);
